...
|---|---:|---:|---:|---:|---|
| mécses / lámpás | 29 | **16** | **1** | ~14 | **vinni** |
...
- **sík minta kinyomtatva a falra — ELVETVE.** A 33 igazolt layered bolt 1 581 review-jából és 777
...
- **rétegelt lámpa — IGAZOLVA, ez a legerősebb termékforma-hiány.** 29 review **16 különböző
  listingen**, miközben a 33 igazolt bolt katalógusában **egy** ilyen tétel van. A funkcionális
...
1. **Kereszt + mandala + zászló kombók** — a legszélesebb bizonyított kereslet (index 3,41, 44
   különböző listing).
2. **Mécses / lámpás csomagok** — a legtisztább kínálati hiány, ugyanabból a rétegezési
   pipeline-ból ([[workflows/production-pipeline]]).
