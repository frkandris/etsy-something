---
type: Shop
title: WoodLusterStore — a legkisebb működő katalógus
description: Argentína, 29 listing, 96% layered, 315 ezer HUF/hó, nulla akció.
status: stable
generated:
  by: claude-opus-5
...
**AR · 1,1 év · 29 listing · 4,9★ · layered arány 96%**

| metrika | érték |
|---|---:|
| korrigált bevétel | 315 434 HUF/hó |
| HUF/listing | **10 877** |
| tényleges ár | $9,00 |
| tartós kedvezmény | **0%** |

A **legkisebb katalógusú igazolt bolt**, ami érdemi bevételt termel. Termék: vallási és mandala
...
(a katalógus-mintavétel viszont 96%-ot mutatott).
